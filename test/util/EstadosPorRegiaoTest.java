...
public class EstadosPorRegiaoTest {
    ...
    @Test
    public void TesteDeEstadosDaRegiaoCentroOesteUsandoStrategy(){
        List<Estados> lista = Regioes.CENTROOESTE.getEstados();
    ...
    @Test
    public void TesteDeEstadosDaRegiaoNordesteUsandoStrategy(){
        List<Estados> lista = Regioes.NORDESTE.getEstados();
    ...
    @Test
    public void TesteDeEstadosDaRegiaoNorteUsandoStrategy(){
        List<Estados> lista = Regioes.NORTE.getEstados();
    ...
    @Test
    public void TesteDeEstadosDaRegiaoSudesteUsandoStrategy(){
        List<Estados> lista = Regioes.SUDESTE.getEstados();
    ...
    @Test
    public void TesteDeEstadosDaRegiaoSulUsandoStrategy(){
        List<Estados> lista = Regioes.SUL.getEstados();
